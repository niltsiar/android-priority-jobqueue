package dev.niltsiar.android.jobqueue.callback;
...
public interface JobManagerCallback {
     ...
     * {@link dev.niltsiar.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} while it was running.
     *
     * @see dev.niltsiar.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)
     * @see dev.niltsiar.android.jobqueue.JobManager#cancelJobsInBackground(CancelResult.AsyncCancelCallback, TagConstraint, String...)
     */
     ...
     *                         {@link dev.niltsiar.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} request.
