package dev.niltsiar.android.jobqueue.config;

import android.content.Context;
import android.net.ConnectivityManager;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import dev.niltsiar.android.jobqueue.DefaultQueueFactory;
import dev.niltsiar.android.jobqueue.JobQueue;
import dev.niltsiar.android.jobqueue.QueueFactory;
import dev.niltsiar.android.jobqueue.di.DependencyInjector;
import dev.niltsiar.android.jobqueue.log.CustomLogger;
import dev.niltsiar.android.jobqueue.log.JqLog;
import dev.niltsiar.android.jobqueue.network.NetworkUtil;
import dev.niltsiar.android.jobqueue.network.NetworkUtilImpl;
import dev.niltsiar.android.jobqueue.timer.SystemTimer;
import dev.niltsiar.android.jobqueue.timer.Timer;
import java.util.concurrent.ThreadFactory;
import java.util.regex.Pattern;

/**
 * {@link dev.niltsiar.android.jobqueue.JobManager} configuration object
 */
...
public class Configuration {
    ...
    public static final class Builder {
         ...
         * {@link dev.niltsiar.android.jobqueue.inMemoryQueue.SimpleInMemoryPriorityQueue}
