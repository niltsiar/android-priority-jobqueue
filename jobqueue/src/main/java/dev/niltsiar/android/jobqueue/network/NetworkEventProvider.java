package dev.niltsiar.android.jobqueue.network;

/**
 * An interface that NetworkUtil can implement if it supports a callback method when network state is changed
 * This is not mandatory but highly suggested so that {@link dev.niltsiar.android.jobqueue.JobManager} can avoid
...
public interface NetworkEventProvider {
    ...
    interface Listener {
        /**
         * @param networkStatus {@link dev.niltsiar.android.jobqueue.network.NetworkUtil.NetworkStatus}
         */
