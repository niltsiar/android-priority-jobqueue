package dev.niltsiar.android.jobqueue.test.timer;
...
public class MockTimer implements Timer {
    private long now;
    private final CopyOnWriteArrayList<ObjectWait> waitingList = new CopyOnWriteArrayList<>();
    ...
    private final Map<Object, Boolean> anyObjectToNotify = new WeakHashMap<>();
