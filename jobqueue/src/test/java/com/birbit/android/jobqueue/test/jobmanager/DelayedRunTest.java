...
public class DelayedRunTest extends JobManagerTestBase {
    @Test
    public void testDelayedRun() throws
                                 Exception {
        delayedRunTest(false);
    }

    @Test
    public void testDelayedRunTryToStop() throws
                                          Exception {
        delayedRunTest(true);
    }

    @Test
    public void testDelayWith0Consumers() throws
                                          InterruptedException {
        JobManager jobManager = createJobManager(new Configuration.Builder(RuntimeEnvironment.application).minConsumerCount(0)
                                                                                                          .maxConsumerCount(3)
                                                                                                          .timer(mockTimer));
    ...
    public void delayedRunTest(boolean tryToStop) throws
                                                  Exception {
        ...
        jobManager.addCallback(new JobManagerCallbackAdapter() {
            ...
            public void onJobRun(@NonNull Job job, int resultCode) {
                ...
                System.out.println("CB job run " + job.getTags()
